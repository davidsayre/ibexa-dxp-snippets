...
final class TagKeyword extends TagsVisitor implements CriterionVisitor
{

    public function supports(Criterion $criterion, LanguageFilter $languageFilter): bool
    {
        if ($criterion instanceof TagKeywordCriterion) {
    ...
    protected function queryThisClassThisField($criterion) {
        ...
        $query->addFilter(new QueryDSL\TermsQuery($classFieldTarget[0] . '_' . $classFieldTarget[1] . '_'.$this->fieldName.'_ms', $criterion->value));
        return $query;
    }
