...
class AdminReportContentRichTextImagesMenuSubscriber implements EventSubscriberInterface
{

    const MENU_KEY_REPORTS = 'Reports';
    const MENU_KEY_CONTENT_ACTIVITY = 'mail__reports__richtext_images__menu';
    ...
    public function onMainMenuConfigure(ConfigureMenuEvent $event)
    {
        ...
        $customMenuItem->addChild(
            ...
            [
                'label' => 'RichText Images',
                'route' => 'admin-ui.reports.richtext_images',
                'attributes' => [
